...
.message__box__error{
    ...
    display: inline-flex;
    align-items: center;
    box-shadow: 0px 0.5px 7px rgba(255, 0, 0, 0.40);
    opacity: 0;
    transform: translateY(100px);
    visibility: hidden;
    transition: 0.5s ease-out;
}
.message__box__error__icon{
    font-size: 30px;
    width: 35%;
    text-align: center;
}
.message__box__error__icon i{
    margin-top: 5px;
    color: #E13232;
}
.message__box__error__text{
    text-align: left;
    margin-left: 30px;
    color: #E13232;
    width: 90%;
}
.message__box__error--open{
    opacity: 1;
    visibility: visible;
...
.message__box__ok{
    ...
    display: inline-flex;
    align-items: center;
    box-shadow: 0px 0.5px 7px rgba(0, 255, 0, 0.40);
    opacity: 0;
    transform: translateY(100px);
    visibility: hidden;
    transition: 0.5s ease-out;
}
.message__box__ok__icon{
    font-size: 30px;
    width: 35%;
    text-align: center;
}
.message__box__ok__icon i{
    margin-top: 5px;
    color: #246942;
}
.message__box__ok__text{
    text-align: left;
    margin-left: 30px;
    color: #246942;
    width: 90%;
}
.message__box__ok--open{
    opacity: 1;
    visibility: visible;
    transform: translateY(0px);
}
...
.selector__two__input input{
    display: none;
}
.selector__two__input label{
    position: relative;
    margin: 6px auto;
    width: 114px;
    cursor: pointer;
...
.selector__two__input label span{
    position: absolute;
    top: 47%;
    left: 0;
    right: 0;
...
.selector__two__input input:checked + label{
    background-color: #fff;
    transition: 0.3s;
    box-shadow: 0px 0.5px 4px rgba(0, 0, 0, 0.25);
    border-radius: 10px;
...
input:checked + .switch__static__label .circle::after {
    margin-left: 32px;
    transition: 0.3s;
}
input:checked + .switch__static__label{
    /* background: #65C466; */
    transition: 0.3s;
    background-color: #007AFF;
}
...
.range__container input{
    width: 100%;
    background: linear-gradient(to right, #007AFF 0%, #007AFF 0%, #D8D8D9 0%, #D8D8D9 100%);
    border-radius: 8px;
    height: 7px;
    outline: none;
...
.range__container input::-webkit-slider-thumb {
    appearance: none;
    width: 25px;
    height: 25px;
    top: -50%;
...
.range__container input::-moz-range-thumb {
    appearance: none;
    width: 25px;
    height: 25px;
    border: none;
...
/* --------------------Button Send-------------- */
.displayScrollText__send{
    margin:0 auto 100px;
    text-align: center;
}
.displayScrollText__send button{
    cursor: pointer;
    width: 131px;
    height: 40px;
    left: 661px;
...
.alarm__box__constent__posicion{
    margin-top: 14px;
    margin-bottom: 14px;
    display: flex;
    width: 432px;
...
.alarm__box__content--day{
    display: flex;
    align-items: center;
    margin-bottom: 10px;
}
.alarm__box__content--day .icon {
    font-size: 10px;
    margin-bottom: 2px;
    display: flex;
}
.alarm__box__content--day .content {
    margin-left: 6px;
    font-size: 15px;
    display: flex;
}
.alarm__box__content--time{
    font-size: 40px;
    margin-bottom: 8px;
}
.alarm__box__content--name{
    font-size: 17px;
}
...
.alarm__btnadd--icon{
    ...
    margin: 0 auto;
    background: #007AFF;
    box-shadow: 0px 0.5px 4px #007AFF;
    border-radius: 50px;
    transition: 0.3s;
}
.alarm__btnadd--icon i {
    position: absolute;
    top: 50%;
    left: 50%;
    transform: translate(-50%,-50%);
...
.alarm__box--none div span{
    font-size: 40px;
}
.alarm__box--none div p{
    color: #717171;
}
/*---------------------Alarm delete---------------*/
...
.alarm__add__time--min input:hover, .alarm__add__time--hours input:hover{
    border-bottom: 2px solid #000;
}
.alarm__add__time--min input:focus, .alarm__add__time--hours input:focus{
    border-bottom: 2px solid #000;
}
...
.alarm__add__day--input input{
    display: none;
}
.alarm__add__day--input {
    position: relative;
    margin-left: 10px;
    margin-right: 10px;
}
.alarm__add__day--input .case label{
    position: absolute;
    height: 100%;
    width: 100%;
    color: #A3A3A3;
...
.alarm__add__day--input .case {
    width: 30px;
    height: 58px;
    border-bottom: 2px solid #A3A3A3;
    transition: 0.2s;
}
.alarm__add__day--input input:checked + .case{
    transition: 0.2s;
    border-bottom: 2px solid #007AFF;

}
.alarm__add__day--input input:checked + .case label{
    color: #007AFF;
    transition: 0.2s;
}
.alarm__add__name{
...
.alarm__add__display{
    animation: moveDowntoUp 0.3s linear;
}
.alarm__add__hidden{
    animation: moveUptoDown 0.3s linear;
    opacity: 0;
}
...
.box__card__content--icon{
    width: 50px;
    height: 100%;
}
.box__card__content--arrow{
    width: max-content;
    margin-right: 50px;
    cursor: pointer;
    transition: 0.3s;
}
.box__card__content--name{
    width: 70%;
    height: 100%;
}
.box__card__open{
...
.box__card__content--name .title{
    font-style: normal;
    font-weight: normal;
    font-size: 20px;
    line-height: 18px;
}
.box__card__content--name .description{
    font-style: normal;
    font-weight: normal;
    font-size: 10px;
    line-height: 18px;
...
.brightness__slider input::-webkit-slider-thumb {
    appearance: none;
    width: 25px;
    height: 25px;
    top: -50%;
...
.brightness__slider input::-moz-range-thumb {
    appearance: none;
    width: 25px;
    height: 25px;
    border: none;
...
.brightness__slider .range__value{
    position: absolute;
    top: -50px;
    margin-left: -13px;
    border-radius: 16px;
...
.brightness__slider .range__value span{
    position: absolute;
    top: 50%;
    left: 50%;
    transform: translate(-50%, -50%);
...
.brightness__slider .range__value .triangle{
    position: absolute;
    z-index: -10;
    top: 17px;
    left: 0px;
    ...
    -webkit-filter: drop-shadow(0 1px 4px rgba(0, 0, 0, 0.50));
...
/* ----------------------------------Night Mode BOX------------------------------------ */
.night__mode__box__time{
    margin: 40px 0 0 ;
}
.night__mode__box__container__time{
    display: flex;
...
.night__mode__box__container__time__title{
    margin-right: 10px;
    margin-bottom: 10px;
    width: 50px;
    text-align: right;
}
.night__mode__box__container__time__picker{
    display: flex;
    align-items: center;
    font-size: 40px;
}
.night__mode__box__container__time__picker span{
    margin: 0 5px;
}
.night__mode__box__container__time__picker input{
    width: 50px;
    text-align: center;
    font-size: 40px;
    border: none;
...
.night__mode__box__container__time__picker input:focus{
    border-bottom: 2px solid #000;
}
...
.timeZone .form__input__constaner--input{
    width: 270px;
}
...
.form__TimeZone--input{
    width: 90px;
    height: max-content;
}
.form__TimeZone--input input:disabled{
    width: 90%;
    margin: auto;
    height: 47px;
    font-size: 20px;
...
.form__TimeZone--input input::-webkit-outer-spin-button,
.form__TimeZone--input input::-webkit-inner-spin-button {
  -webkit-appearance: none;
  margin: 0;
}
.form__TimeZone--plus button, .form__TimeZone--minus button{
...
.timeZone__message--icon{
    width: 40px;
    font-size: 26px;
    color: #007AFF;
}
.timeZone__message--text{
    font-size: 14px;
    line-height: 18px;
    width: 237px;
    height: 81px;
}
.timeZone__message--text a{
    color: #007AFF;
}
.timeZone--btn{
    margin-top: 25px;
...
.temperature__shunter{
    display: flex;
    margin: 60px 0 60px;
    justify-content: center;
    align-items: center;
}
.temperature__shunter--input{
    width: 90px;
    height: max-content;
}
.temperature__shunter--input input:disabled{
    width: 90%;
    margin: auto;
    height: 47px;
    font-size: 20px;
...
.temperature__unit__radio__input input, .temperature__unit__radio__input label{
    display: inline;
}
.temperature__unit{
    width: auto;
...
.temperature__unit__text{
    font-size: 16px;
}
.temperature__unit__radio__input{
    margin: 10px 0;
    font-size: 16px;
}

.temperature__shunter--input input::-webkit-outer-spin-button,
.temperature__shunter--input input::-webkit-inner-spin-button {
  -webkit-appearance: none;
  margin: 0;
}
.temperature__shunter--plus button, .temperature__shunter--minus button{
    background-color: transparent;
    margin: 0px 15px 0;
    border: none;
    cursor: pointer;
...
.box__weather--api .form__input__constaner--input{
    width: 270px;
}
.weather__message--text{
    font-size: 14px;
    line-height: 18px;
    width: 207px;
    height: 81px;
...
.weather__message--text a{
    color: #007AFF;
}

/* ----------------------------------Display Setting BOX------------------------------------ */

.display__setings__selector{
    margin-top: 40px;
}
.display__setings__selector__date input, .display__setings__selector__temp input{
    display: none;
}

.display__setings__selector__date label, .display__setings__selector__temp label{
    position: relative;
    ...
    height: 65px;
    border: 2px solid #32344b9a;
    box-sizing: border-box;
    border-radius: 14px;
    cursor: pointer;
    transition: 0.7s;
}
.display__setings__selector__date label .mark, .display__setings__selector__temp label .mark{
    left: 15px;
    top: 50%;
    transform: translate(0, -50%);
    position: absolute;
...
.display__setings__selector__date label .mark::after, .display__setings__selector__temp label .mark::after{
    content: "";
    transition: 0.7s;
    border-radius: 50%;
}
.display__setings__selector__date input:checked + label .mark, .display__setings__selector__temp input:checked + label .mark{
    border: 2px solid #007AFF;
    transition: 0.7s;
}
.display__setings__selector__date input:checked + label .mark::after, .display__setings__selector__temp input:checked + label .mark::after{
    content: "";
    position: absolute;
    top: 2px;
    left: 2px;
...
.display__setings__selector__date input:checked + label, .display__setings__selector__temp input:checked + label{
    width: 271px;
    height: 65px;
    border: 2px solid #007AFF;
    box-sizing: border-box;
...
.display__setings__selector__temp__content, .display__setings__selector__date__content{
    width: 175px;
    position: relative;
    height: 40px;
    background: #dbdbdb88;
...
.display__setings__selector__temp input:checked + label .display__setings__selector__temp__content, .display__setings__selector__date input:checked + label .display__setings__selector__date__content{
    background: #CFE6FF;
    color: #007AFF;
    transition: 0.3s;
...
.display__setings__selector__temp__content span, .display__setings__selector__date__content span{
    line-height: 40px;
}
.display__setings__selector__temp__content span:nth-child(2){
    font-size: 13px;
}
.display__setings__selector__temp__content span:nth-child(3){
    margin-left: 50px;
}
.displaySettings--btn{
    margin-top: 40px;
...
/* ----------------------------------UPDATE BOX------------------------------------ */
.update__firmware__info{
    align-items: center;
    display: flex;
    width: max-content;
    margin: 10px auto 10px;
}
.update__firmware__info span{
    font-style: normal;
    font-weight: normal;
    font-size: 17px;
    margin-top: -5px;
}
.update__firmware__info--icon {
    margin-right: 10px;
    font-size: 22px;
    color: #007AFF;
}

.firmware__drop__section{
    position: relative;
    width: 254px;
    height: 253px;
    margin: 50px auto;
    border: 3px dashed #32344B;
    box-sizing: border-box;
    border-radius: 16px;
    transition: all 0.1s ease-out;
}
.firmware__drop__section__input{
    position: absolute;
    opacity: 0;
    cursor: pointer;
    height: 180px;
}
.firmware__drop__section__content__file__icon{
    width: max-content;
    margin: 30px auto;
    pointer-events: none;
}
.firmware__drop__section__content__watermark{
    pointer-events: none;
}
.firmware__drop__section__content__text{
    width: 160px;
    height: 35px;
    font-family: Roboto;
    font-style: normal;
...
.firmware__drop__section--over{
    background-color: #E2F0FF;
    transition: all 0.1s ease-in;
    border: 3px dashed #007AFF;
}
.firmware__drop__section--ok{
    border: 3px dashed #34B951;
    transition: all 0.1s ease-in;
}
.firmware__drop__section--ok button{
    background-color: #34B951;
    transition: all 0.1s ease-in;
}

.firmware__drop__section--error{
    border: 3px dashed #E94646;
    transition: all 0.1s ease-in;
}
.firmware__drop__section--error button{
...
.update__firware__none{
    display: flex;
    width: 270px;
    margin-left: 20px;
    align-items: center;
}
.update__firware__none--icon{
    margin-right: 10px;
    color: #2F965B;
    font-size: 26px;
}
...
.update__firware__message__icon{
    margin-right: 10px;
    font-size: 22px;

}
.update__firware__message__text{
    width: 200px;
}
...
/* ----------------------------------NETWORK BOX------------------------------------ */
.network__name, .network__pass{
    width: 300px;
}
.network__name .form__input__constaner--input, .network__pass .form__input__constaner--input, .mqtt_topic .form__input__constaner--input{
    width: 270px;
}
.static__address__ip--title{
    font-style: normal;
...
.static__address__ip__message{
    margin-top: 7px;
    display: flex;
    justify-content: center;

}
.static__address__ip__message--icon{
    width: 40px;
    font-size: 26px;
    color: #007AFF;
}
.static__address__ip__message--text{
    font-size: 14px;
    line-height: 18px;
    width: 237px;
    height: 81px;
}
.static__address__ip__message--text a{
    color: #007AFF;
}
...
.mqtt_user .form__input__constaner--input, .mqtt_pass .form__input__constaner--input, .mqtt_topic .form__input__constaner--input{
    width: 270px;
}
.mqqtt__static__IP{
    margin: auto;
...
.menu__category__text, .menu__category__settings{
    width: 33%;
    display: table-cell;
...
.menu__category__text--text, .menu__category__settings--text{
    font-style: normal;
    font-weight: normal;
    font-size: 20px;
    line-height: 18px;
}
.menu__category__settings--icon, .menu__category__text--icon{
    font-size: 30px;
}

.menu__category__settings:hover, .menu__category__text:hover{
...
.menu__tab__open{
    ...
    <div class="message__box__error">
        <div class="message__box__error__icon">
            <i class='bx bx-error-circle'></i>
        </div>
        <div class="message__box__error__text">
            <span>Fetch error</span>
        </div>
    </div>
    <div class="message__box__ok">
        <div class="message__box__ok__icon">
            <i class='bx bx-check-circle'></i>
        </div>
        <div class="message__box__ok__text">
            <span>Successes</span>
        </div>
    </div>
    <div id="menuTab" class="menu__tabs">
        <div class="logo">
            <img src="https://czubixx.xyz/supersmartclock/icon/logo.svg">
        </div>
        <div class="displayScrollText">
            <div class="displayScrollText--title">
                <span>Display Scrolling Text</span>
            </div>
            <div class="form__input__constaner">
                <label class="form__input__constaner--label close">Text</label>
                <input class="form__input__constaner--input" type="text" name="sendText" id="sendText">
                <div class="form__input__constaner--description"><span>Max 128 characters.</span></div>
            </div>
            <div class="range__container">
                <label for="repetitions">Speed: </label>
                <input type="range" min="50" max="70" value="60" name="range" id="repetitions"><br>
            </div>
            <div class="displayScrollText__send">
                <button onclick="displayScrollTestHandling()">Wyślij</button>
            </div>
        </div>
    </div>
    <!------------------------------- Alarm ------------------------------------- -->
    ...
    <div id="menuTab" class="menu__tabs">
        <div class="alarm__filtr" id="alarmFiltr" onclick="hideAlarmEdit()" hidden></div>
        <div class="logo">
            <img src="https://czubixx.xyz/supersmartclock/icon/logo.svg">
        </div>
        
        <div class="alarm__conatainer" >
        ...
        <div class="alarm__btnadd">
            <div class="alarm__btnadd--icon" id="alarmAddBtn">
                <i class='bx bx-plus'></i>
            </div>
        </div>

        <div class="alarm__add" id="alarmAddCard" hidden>
            <div class="alarm__add__content">
                <div class="alarm__add__time">
                    <div class="alarm__add__time--hours">
                        <input  value="12" min="0" max="23" type="number" name="alarmAddHours" id="alarmAddHours">
                    </div>
                    <div>
                        <span> : </span>
                    </div>
                    <div class="alarm__add__time--min">
                        <input value="00" min="0" max="59" type="number" name="alarmAddMin" id="alarmAddMin">
                    </div>
                </div>
                <div class="alarm__add__day">
                    <div class="alarm__add__day--input">
                        <input type="checkbox" id="alarmAddDayMON" name="alarmAddDay">
                        <div class="case">
                            <label for="alarmAddDayMON">Mon</label>
                        </div>
                    </div>
                    <div class="alarm__add__day--input">
                        <input type="checkbox" id="alarmAddDayTue" name="alarmAddDay">
                        <div class="case">
                            <label for="alarmAddDayTue">Tue</label>
                        </div>
                    </div>
                    <div class="alarm__add__day--input">
                        <input type="checkbox" id="alarmAddDayWed" name="alarmAddDay">
                        <div class="case">
                            <label for="alarmAddDayWed">Wed</label>
                        </div>
                    </div>
                    <div class="alarm__add__day--input">
                        <input type="checkbox" id="alarmAddDayThu" name="alarmAddDay">
                        <div class="case">
                            <label for="alarmAddDayThu">Thu</label>
                        </div>
                    </div>
                    <div class="alarm__add__day--input">
                        <input type="checkbox" id="alarmAddDayFri" name="alarmAddDay">
                        <div class="case">
                            <label for="alarmAddDayFri">Fri</label>
                        </div>
                    </div>
                    <div class="alarm__add__day--input">
                        <input type="checkbox" id="alarmAddDaySat" name="alarmAddDay">
                        <div class="case">
                            <label for="alarmAddDaySat">Sat</label>
                        </div>
                    </div>
                    <div class="alarm__add__day--input">
                        <input type="checkbox" id="alarmAddDaySun" name="alarmAddDay">
                        <div class="case">
                            <label for="alarmAddDaySun">Sun</label>
                        </div>
                    </div>
                </div>
                <div class="form__input__constaner alarm__add__name">
                    <label class="form__input__constaner--label close">Alarm name</label>
                    <input class="form__input__constaner--input" type="text" name="alarmAddName" id="alarmAddName">
                    <div class="form__input__constaner--description">
                        <span>Max 64 characters.</span>
                    </div>
                </div>

                <div class="btn alarm__add--btn">
                    <button onclick="alarmAddHandler()">Add alarm</button>
                </div>
            </div>
        </div>
        </div>
    ...
    <div id="menuTab" class="menu__tabs">
        ...
        <div class="box">
            <div class="box__card">
                <div class="box__card__content">
                    <div class="box__card__content--icon">
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M7.4925 15C7.4925 19.1415 10.8615 22.5105 15.003 22.5105C19.1445 22.5105 22.5135 19.1415 22.5135 15C22.5135 10.8585 19.1445 7.4895 15.003 7.4895C10.8615 7.4895 7.4925 10.8585 7.4925 15ZM15.003 10.4895C17.49 10.4895 19.5135 12.513 19.5135 15C19.5135 17.487 17.49 19.5105 15.003 19.5105C12.516 19.5105 10.4925 17.487 10.4925 15C10.4925 12.513 12.516 10.4895 15.003 10.4895ZM13.5 25.5H16.5V30H13.5V25.5ZM13.5 0H16.5V4.5H13.5V0ZM0 13.5H4.5V16.5H0V13.5ZM25.5 13.5H30V16.5H25.5V13.5ZM3.3315 24.5445L6.5115 21.3615L8.634 23.4825L5.454 26.6655L3.3315 24.5445ZM21.363 6.516L24.546 3.333L26.667 5.454L23.484 8.637L21.363 6.516ZM6.516 8.6385L3.333 5.4555L5.4555 3.3345L8.6355 6.5175L6.516 8.6385ZM26.667 24.546L24.546 26.667L21.363 23.484L23.484 21.363L26.667 24.546Z" fill="black"/>
                        </svg> 
                    </div>      
                    <div class="box__card__content--name">   
                        <span class="title">Brightness</span><br>
                        <span class="description">Display brightness settings</span>
                    </div>  
                    <div class="box__card__content--arrow">
                        <img src="https://czubixx.xyz/supersmartclock/icon/arrow.svg">                  
                    </div>        
                </div>
            </div>
            <div class="box__content" style="height: 0px;">
                <div class="selector__two">
                    <div class="selector__two__input">
                        <input type="radio" name="brightness" class="brightness--auto" id="brightness--auto" value="auto" >
                        <label for="brightness--auto"><span>Auto</span></label>
                    </div>
                    <div class="selector__two--line"><span></span></div>
                    <div class="selector__two__input">
                        <input type="radio" name="brightness" class="brightness--manual" id="brightness--manual" value="manual" checked>
                        <label for="brightness--manual"><span>Manual</span></label>
                    </div>
                </div>
                <div class="brightness__slider ">
                    <div class="range__value" id="range__value"></div>
                    <input type="range" min="0" max="15" value="10" name="range" id="brightness"><br>
                </div>
                <div class="btn brightness__saveButton">
                    <button onclick="brightnessHandling()">Save</button>
                </div>
            </div>
        </div>
        ...
        <div class="box">
            <div class="box__card">
                <div class="box__card__content">
                    <div class="box__card__content--icon">
                        <i class='bx bx-moon' style="font-size: 36px;"></i>
                    </div>      
                    <div class="box__card__content--name">   
                        <span class="title">Night mode</span><br>
                        <span class="description">Configuration of the night mode</span>
                    </div>  
                    <div class="box__card__content--arrow">
                        <img src="https://czubixx.xyz/supersmartclock/icon/arrow.svg">                  
                    </div>        
            ...
            <div class="box__content" style="height: 0px;">
                <div class="night__mode__box__container">
                    <div class="switch__static night__mode__switch">
                        <div class="switch__static--posicion">
                            <div>
                                <input type="checkbox" name="nightModeSwitch" id="nightModeSwitch">
                                <label for="nightModeSwitch" class="switch__static__label">
                                    <span class="circle"></span>
                                </label>
                            </div>
                            <div class="switch__static__name">
                    ...
                    <div class="night__mode__box__time">
                        <div class="night__mode__box__container__time">
                            <div class="night__mode__box__container__time__title">
                                <span>from</span>
                            </div>
                            <div class="night__mode__box__container__time__picker">
                                <input type="number" value="22" name="nightModeFromHours" id="nightModeFromHours"> <span>:</span><input type="number" value="59" name="nightModeFromMin" id="nightModeFromMin">
                            </div>
                        </div>
                        ...
                        <div class="night__mode__box__container__time">
                            ...
                            <div class="night__mode__box__container__time__picker">
                                <input type="number" value="22" name="nightModeToHours" id="nightModeToHours"> <span>:</span><input type="number" value="59" name="nightModetoMin" id="nightModetoMin">
                            </div>
                        </div>
                    </div>
                    <div class="btn night__mode__save">
                        <button onclick="nightModeHandling()">Save</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="box">
            <div class="box__card">
                <div class="box__card__content">
                    <div class="box__card__content--icon">
                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15 0C6.729 0 0 6.729 0 15C0 23.271 6.729 30 15 30C23.271 30 30 23.271 30 15C30 6.729 23.271 0 15 0ZM15 27C8.3835 27 3 21.6165 3 15C3 8.3835 8.3835 3 15 3C21.6165 3 27 8.3835 27 15C27 21.6165 21.6165 27 15 27Z" fill="black"/>
                            <path d="M15.9743 8H13V15.4616L17.8972 20L20 18.0512L15.9743 14.3204V8Z" fill="black"/>
                        </svg>     
                    </div>      
                    <div class="box__card__content--name">   
                        <span class="title">Time Zone</span><br>
                        <span class="description">Configuring time zone settings</span>
                    </div>  
                    <div class="box__card__content--arrow">
                        <img src="https://czubixx.xyz/supersmartclock/icon/arrow.svg">                  
                    </div>        
            ...
            <div class="box__content"  style="height: 0px;">
                <div class="form__input__constaner timeZone">
                    <label class="form__input__constaner--label close">NTP Server IP</label>
                    <input class="form__input__constaner--input" type="text" name="timeZone" id="timeZone">
                    <div class="form__input__constaner--description"><span>Max 32 characters.</span></div>
                </div>
                <div class="form__TimeZone">
                    <div class="form__TimeZone--minus">
                        <button id="timeUTPZone--minus">
                            <svg width="22" height="2" viewBox="0 0 22 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <line x1="12" y1="1" x2="22" y2="1" stroke="#32344B" stroke-width="2"/>
                                <line x1="1.74846e-07" y1="1" x2="10" y2="1" stroke="#32344B" stroke-width="2"/>
                                <rect x="10" width="2" height="2" fill="#32344B"/>
                            </svg>
                    </button>
                    </div>
                    <div class="form__TimeZone--input">
                        <input type="text" value="+0 h" name="timeUTPZone" id="timeUTPZone" disabled>
                    </div>
                    <div class="form__TimeZone--plus">
                        <button id="timeUTPZone--plus">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <line x1="11" x2="11" y2="10" stroke="#32344B" stroke-width="2"/>
                                <line x1="11" y1="12" x2="11" y2="22" stroke="#32344B" stroke-width="2"/>
                                <line x1="12" y1="11" x2="22" y2="11" stroke="#32344B" stroke-width="2"/>
                                <line x1="1.74846e-07" y1="11" x2="10" y2="11" stroke="#32344B" stroke-width="2"/>
                                <rect x="10" y="10" width="2" height="2" fill="#32344B"/>
                            </svg>
                        </button>
                    </div>
                </div>
                <div class="timeZone__message">
                    <div class="timeZone__message--icon">
                        <i class='bx bx-info-circle'></i>
                    </div>
                    <div class="timeZone__message--text">
                        <span>
                            NTP servers allow you to display the time,
                            you can get the NTP server IP address for 
                            your time location from <a href="https://gist.github.com/mutin-sa/eea1c396b1e610a2da1e5550d94b0453" target="_blank">github.com</a>
                        </span>
                    </div>
                </div>
                <div class="btn timeZone--btn">
                    <button onclick="timeZoneHandling()">Save and Reboot</button>
                </div>
            </div>
        </div>
        ...
        <div class="box">
            <div class="box__card">
                <div class="box__card__content">
                    <div class="box__card__content--icon">
                        <i class='bx bxs-thermometer' style="font-size: 30px;" ></i>
                    </div>      
                    <div class="box__card__content--name">   
                        <span class="title">Temperature</span><br>
                        <span class="description">Configuring mqtt settings</span>
                    </div>  
                    <div class="box__card__content--arrow">
                        <img src="https://czubixx.xyz/supersmartclock/icon/arrow.svg">                  
                    </div>        
            ...
            <div class="box__content"  style="height: 0px;">
                <div class="selector__two">
                    <div class="selector__two__input">
                        <input type="radio" name="tempUnit" id="tempUnitC" value="c" >
                        <label for="tempUnitC"><span>Celsius</span></label>
                    </div>
                    <div class="selector__two--line"><span></span></div>
                    <div class="selector__two__input">
                        <input type="radio" name="tempUnit" id="tempUnitF" value="f">
                        <label for="tempUnitF"><span>Fahrenheit</span></label>
                    </div>
                </div>

                <div class="temperature__shunter">
                    <div class="temperature__shunter--minus">
                        <button id="tempMinus">
                            <svg width="22" height="2" viewBox="0 0 22 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <line x1="12" y1="1" x2="22" y2="1" stroke="#32344B" stroke-width="2"/>
                                <line x1="1.74846e-07" y1="1" x2="10" y2="1" stroke="#32344B" stroke-width="2"/>
                    ...
                    <div class="temperature__shunter--input">
                        <input type="text" value="+0" name="temperature" id="temperature" disabled>
                    </div>
                    <div class="temperature__shunter--plus">
                        <button id="tempPlus">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <line x1="11" x2="11" y2="10" stroke="#32344B" stroke-width="2"/>
                                <line x1="11" y1="12" x2="11" y2="22" stroke="#32344B" stroke-width="2"/>
                ...
                <div class="btn temperature--btn">
                    <button onclick="temepratureHandling()">Save</button>
                </div>
            </div>
        </div>
        ...
        <div class="box">
            <div class="box__card">
                <div class="box__card__content">
                    <div class="box__card__content--icon">
                        <i class='bx bx-sun' style="font-size: 32px;"></i>
                    </div>      
                    <div class="box__card__content--name">   
                        <span class="title">Weather</span><br>
                        <span class="description">Outdoor temperature configuration</span>
                    </div>  
                    <div class="box__card__content--arrow">
                        <img src="https://czubixx.xyz/supersmartclock/icon/arrow.svg">                  
                    </div>        
            ...
            <div class="box__content box__weather" style="height: 0px;">

                <div class="selector__two">
                    <div class="selector__two__input">
                        <input type="radio" name="weatherUnit" id="weatherUnitC" value="c">
                        <label for="weatherUnitC"><span>Celsius</span></label>
                    </div>
                    <div class="selector__two--line"><span></span></div>
                    <div class="selector__two__input">
                        <input type="radio" name="weatherUnit" id="weatherUnitF" value="f">
                        <label for="weatherUnitF"><span>Fahrenheit</span></label>
                    </div>
                </div>

                <div class="form__input__constaner box__weather--api">
                    <label class="form__input__constaner--label close">API key</label>
                    <input class="form__input__constaner--input" type="text" name="weatherKey" id="weatherKey">
                    <div class="form__input__constaner--description"><span>Max 32 characters.</span></div>
                </div>
                <div class="form__input__constaner box__weather--api">
                    <label class="form__input__constaner--label close">City Name</label>
                    <input class="form__input__constaner--input" type="text" name="weatherCity" id="weatherCity">
                    <div class="form__input__constaner--description"><span>Max 64 characters.</span></div>
                </div>
                <div class="timeZone__message">
                    <div class="timeZone__message--icon">
                    ...
                    <div class="weather__message--text">
                        <span>
                            See how to get the api key on the site <a href="https://openweathermap.org/appid" target="_blank">openweathermap.org</a><br>
                            Check if your town is supported <a href="https://openweathermap.org/find?q=" target="_blank">openweathermap.org</a>
                        </span>
                    </div>
                </div>
                <div class="btn temperature--btn">
                    <button onclick="weatherHandling()">Save and Reboot</button>
                </div>
            </div>
        </div>
        ...
        <div class="box">
            <div class="box__card">
                <div class="box__card__content">
                    <div class="box__card__content--icon">
                        <i class='bx bx-tv' style="font-size: 32px;"></i>
                    </div>      
                    <div class="box__card__content--name">   
                        <span class="title">Display Setting</span><br>
                        <span class="description">Display management</span>
                    </div>  
                    <div class="box__card__content--arrow">
                        <img src="https://czubixx.xyz/supersmartclock/icon/arrow.svg">                  
                    </div>        
            ...
            <div class="box__content" style="height: 0px;">
                ...
                <div class="selector__two">
                    <div class="selector__two__input">
                        <input type="radio" name="disaplySetings" id="disaplySetingsClick" value="c">
                        <label for="disaplySetingsClick"><span>After click</span></label>
                    </div>
                    <div class="selector__two--line"><span></span></div>
                    <div class="selector__two__input">
                        <input type="radio" name="disaplySetings" id="disaplySetingsAuto" value="a">
                        <label for="disaplySetingsAuto"><span>Auto scroll</span></label>
                    </div>
                </div>

                <div class="display__setings__selector">
                    <div class="display__setings__selector__date">
                        <input type="radio" name="disaplySetingsSelector" id="disaplySetingsSelectorDate" value="a">
                        <label for="disaplySetingsSelectorDate">
                            <span class="mark"></span>
                            <div class="display__setings__selector__date__content">
                                <span>23 Nov 2021</span>
                            </div>
                        </label>
                    </div>

                    <div class="display__setings__selector__temp">
                        <input type="radio" name="disaplySetingsSelector" id="disaplySetingsSelectorTemp" value="a">
                        <label for="disaplySetingsSelectorTemp">
                            <span class="mark"></span>
                            <div class="display__setings__selector__temp__content">
                                <span class="home__temp">20</span><span>4</span><span>20°C</span>
                            </div>
                        </label>
                    </div> 

                </div>
                <div class="btn displaySettings--btn">
                    <button onclick="displaySettingsHandling()">Save</button>
                </div>
            </div>
        </div>
        ...
        <div class="box">
            <div class="box__card">
                <div class="box__card__content">
                    <div class="box__card__content--icon">
                        <i class='bx bx-cloud-upload' style="font-size: 32px;"></i>
                    </div>      
                    <div class="box__card__content--name">   
                        <span class="title">Updates</span><br>
                        <span class="description">Update management</span>
                    </div>  
                    <div class="box__card__content--arrow">
                        <img src="https://czubixx.xyz/supersmartclock/icon/arrow.svg">                  
                    </div>        
            ...
            <div class="box__content" style="height: 0px;">
                <div class="update__firmware__info">
                    <div class="update__firmware__info--icon">
                        <i class='bx bx-copy-alt'></i>
                    </div>
                    <div class="update__firmware__info--description">
                        <span>Firmware version: </span><span id="firmwareVersion">v1.b</span>
                    </div>
                </div>

                <div class="firmware__drop__section" id="filedropsection">
                    <input class="firmware__drop__section__input" type="file" name="fffff" id="fffff">
                    <div class="firmware__drop__section__content">
                        <div class="firmware__drop__section__content__watermark">
                            <div class="firmware__drop__section__content__file__icon">
                                <img src="https://czubixx.xyz/supersmartclock/icon/upload_file.svg">
                            </div>
                            <div class="firmware__drop__section__content__text">
                                <span id="firmwareDropMessage">Upload or drag and drop the .bin file</span>  
                            </div>
                        </div>
                        <div class="firmware__drop__btn">
                            <button id="checkUpdateBtn" onclick="firmwareHandlerSend()">Update</button>
                        </div>
                    </div>
                </div>
        ...
        <div class="box">
            <div class="box__card">
                <div class="box__card__content">
                    <div class="box__card__content--icon">
                        <i class='bx bx-wifi' style="font-size: 32px;"></i>
                    </div>      
                    <div class="box__card__content--name">   
                        <span class="title">Network</span><br>
                        <span class="description">Network settings</span>
                    </div>  
                    <div class="box__card__content--arrow">
                        <img src="https://czubixx.xyz/supersmartclock/icon/arrow.svg">                  
                    </div>        
            ...
            <div class="box__content"  style="height: 0px;">
                ...
                <div class="switch__static">
                    <div class="switch__static--posicion">
                        <div>
                            <input type="checkbox" name="networkStaticIPSwitch" id="networkStaticIPSwitch">
                            <label for="networkStaticIPSwitch" class="switch__static__label">
                                <span class="circle"></span>
                            </label>
                        </div>
                        <div class="switch__static__name">
                ...
                <div class="static__address__ip static__address__ip--close" id="networkStaticIP">
                    ...
                    <div class="static__address__ip__message">
                        <div class="static__address__ip__message--icon">
                            <i class='bx bx-info-circle'></i>
                        </div>
                        <div class="static__address__ip__message--text">
                            <span>
                                if the ip address is wrong, the device may not catch the errors
                            </span>
                        </div>
                    </div>
                ...
                <div class="btn network__btn__save">
                    <button onclick="networkHandler()">Save and Reboot</button>
                </div>
            </div>
        </div>
        ...
        <div class="box">
            <div class="box__card">
                <div class="box__card__content">
                    <div class="box__card__content--icon">
                        <i class='bx bx-station' style="font-size: 30px;" ></i>  
                    </div>      
                    <div class="box__card__content--name">   
                        <span class="title">MQTT</span><br>
                        <span class="description">Configuring mqtt settings</span>
                    </div>  
                    <div class="box__card__content--arrow">
                        <img src="https://czubixx.xyz/supersmartclock/icon/arrow.svg">                  
            ...
            <div class="box__content mqtt__box"  style="height: 0px;">
                <div class="switch__static mqtt__switch">
                    <div class="switch__static--posicion">
                        <div>
                            <input type="checkbox" name="mqtt__switch" id="mqtt__switch">
                            <label for="mqtt__switch" class="switch__static__label">
                                <span class="circle"></span>
                            </label>
                        </div>
                        <div class="switch__static__name">
                ...
                <div class="form__input__constaner mqtt_user">
                    <label class="form__input__constaner--label close">Name</label>
                    <input class="form__input__constaner--input" type="text" name="MqqttUser" id="MqqttUser">
                    <div class="form__input__constaner--description"><span>Max 32 characters.</span></div>
                </div>
                <div class="form__input__constaner mqtt_pass">
                    <label class="form__input__constaner--label close">Password</label>
                    <input class="form__input__constaner--input" type="password" name="MqqttPass" id="MqqttPass">
                    <div class="form__input__constaner--description"><span>Max 32 characters.</span></div>
                </div>

                <div class="mqqtt__static__IP">
                    <div class="mqqtt__static__IP--title">
                        <span>Broker IP</span>
                    </div>
                    <div class="form__static__addres__container">
                        <input value="0"  type="text" name="mqttip1" id="mqttip1" maxlength="3">
                        <svg width="16" height="2" viewBox="0 0 16 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <line y1="1" x2="16" y2="1" stroke="#32344B" stroke-width="2"/>
                            </svg>
                            
                        <input value="0"  type="text" name="mqttip2" id="mqttip2" maxlength="3">
                        <svg width="16" height="2" viewBox="0 0 16 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <line y1="1" x2="16" y2="1" stroke="#32344B" stroke-width="2"/>
                            </svg>
                            
                        <input value="0" type="text" name="mqttip3" id="mqttip3" maxlength="3">
                        <svg width="16" height="2" viewBox="0 0 16 2" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <line y1="1" x2="16" y2="1" stroke="#32344B" stroke-width="2"/>
                            </svg>
                            
                        <input value="0"  type="text" name="mqttip4" id="mqttip4" maxlength="3">
                    </div>
                </div>

                <div class="form__input__constaner mqtt_topic">
                    <label class="form__input__constaner--label close">Mqtt device topic</label>
                    <input class="form__input__constaner--input" type="text" name="mqttTopic" id="mqttTopic">
                    <div class="form__input__constaner--description"><span>Max 32 characters.</span></div>
                </div>
                <div class="mqtt__message">
                    <div class="mqtt__message--icon">
                        <i class='bx bx-info-circle'></i>
                    </div>
                    <div class="mqtt__message--text">
                        <span>
                            See the addresses to which the request should be sent and the full Mqtt documentation on
                            <a href="https://gist.github.com/mutin-sa/eea1c396b1e610a2da1e5550d94b0453" target="_blank">github.com</a>
                        </span>
                    </div>
                </div>
                <div class="mqqtt__button">
                    <button onclick="mqttHandling()">Save and Reboot</button>
                </div>
            </div>
        </div>
    ...
    <div class="menu__category">
        <div id="menuButton" class="menu__category__text menu__tab__open" onclick="openTabs(0)">
            <div class="menu__category__text--icon">
                <i class='bx bx-text'></i>
            </div>
            <div class="menu__category__text--text">
                <span>Display text</span>
            </div>
        </div> 
        <div id="menuButton" class="menu__category__settings" onclick="openTabs(1)">
            <div class="menu__category__settings--icon">
                <i class='bx bx-alarm'></i>
            </div>
            <div class="menu__category__settings--text">
                <span>Alarm</span>
            </div>
        </div> 
        <div id="menuButton" class="menu__category__settings" onclick="openTabs(2)">
            <div class="menu__category__settings--icon">
                <i class='bx bx-cog'></i>
            </div>
            <div class="menu__category__settings--text">
...
// ---------------DisplaySettings---------------
const displaySettings = document.querySelectorAll('input[name="disaplySetings"]')
const disaplySetingsSelector = document.querySelectorAll('input[name="disaplySetingsSelector"]')
const displaySettingsHandling = () => {
    let data = {
        autoScroll: null,
        type: null
    };
    disaplySetingsSelector[0].checked ? data.type = "date" : data.type = "temp"
    displaySettings[0].checked ? data.autoScroll = false : data.autoScroll = true

    postData('/set/displaysettings', data)
        .then(data => {
            if(data.status == 200){
                messageBox("ok")
            }else{
...
const autoStartTask = async () => {
    ...
    if(jsons.displaySettings){
        if(jsons.displaySettings.autoScroll)
            displaySettings[1].checked = true 
        else
            displaySettings[0].checked = true 

        if(jsons.displaySettings.displayTemp)
            disaplySetingsSelector[1].checked = true
        else
            disaplySetingsSelector[0].checked = true
    }
